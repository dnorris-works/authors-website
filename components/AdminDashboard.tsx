...
export default function AdminDashboardClient({ allBooks }: Props) {
    ...
    return (
        <div className="min-h-screen px-6 py-8" style={{ backgroundColor: '#faf6f1' }}>
            <div className="max-w-4xl mx-auto">

                {/* Header */}
                <div className="flex justify-between items-center mb-10">
                    <h1 className="font-serif text-3xl" style={{ color: '#2c2c2c' }}>
                        Admin Dashboard
                    </h1>
                    <button
                ...
                {allBooks.map(({ author, books }) => (
                    <section key={author.key} className="mb-12">
                        <div className="flex justify-between items-center mb-4">
                            <h2 className="font-serif text-xl" style={{ color: '#2c2c2c' }}>
                                {author.name}
                            </h2>
                            <button
                ...
                {editing && (
                    ...
                    >
                        <div
                            ...
                            style={{ backgroundColor: '#faf6f1', maxHeight: '90vh' }}
                        >
                            <h2 className="font-serif text-xl mb-6" style={{ color: '#2c2c2c' }}>
                                {editing.bookId ? 'Edit Book' : 'New Book'}
                            </h2>

                            <div className="space-y-5">

                                {/* Book ID — only for new books */}
                                {!editing.bookId && (
